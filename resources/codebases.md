...
|-----------|-------------|------|
| EasyDistill | ModelScope OPD toolkit | [GitHub](https://github.com/modelscope/easydistill) |
| OpenRLHF | RLHF + OPD support | [GitHub](https://github.com/OpenRLHF/OpenRLHF) |
| verl | RLHF framework (used by ThinkTuning, SAGE) | [GitHub](https://github.com/volcengine/verl) |
